...
3. Create a `.env` file in your Django project's root directory (same level as `manage.py`). Update the values for the PostgreSQL connection and email credentials that are in settings.py. For email, follow this guide on [how to set up an App Password for Gmail](https://support.google.com/accounts/answer/185833).
